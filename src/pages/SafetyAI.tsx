...
import { HardHat, Shield, AlertTriangle, Eye, Camera, Zap, CheckCircle, ArrowRight, Play } from 'lucide-react';
...
const SafetyAI = () => {
  ...
  const safetyFeatures = [
    {
      icon: HardHat,
      title: 'Baret Tespiti',
      description: 'Çalışanların baret takıp takmadığını gerçek zamanlı olarak tespit eder ve anında uyarı verir.',
      accuracy: '95%',
      color: 'red'
    },
    {
    ...
    },
    {
      ...
      description: 'Yangını anında tespit eder ve mobil uygulama üzerinden fotoğrafla birlikte bildirim gönderir.',
      accuracy: '96%',
      color: 'orange'
    },
    {
      icon: Eye,
      title: 'Düşme Tespiti',
      description: 'Çalışanın yere düştüğünü anında tespit eder ve hızlı müdahale için alarm gönderir.',
      accuracy: '95%',
      color: 'purple'
    }
  ];
  ...
  const useCases = [
    {
      title: 'İnşaat Şantiyeleri',
      description: 'Şantiye alanlarında çalışan güvenliği ve kaza önleme',
    ...
    {
      title: 'Fabrika Üretim Hatları',
      description: 'Üretim alanlarında güvenlik protokolü kontrolü',
      image: 'https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
      stats: { facilities: '150+', efficiency: '%45 ↑', incidents: '%78 ↓' }
    },
    {
      title: 'Enerji Tesisleri',
      description: 'Yüksek riskli enerji tesislerinde güvenlik izleme',
      image: 'https://images.pexels.com/photos/433308/pexels-photo-433308.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
      stats: { plants: '75+', uptime: '%99.9', safety: '%92 ↑' }
    }
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center space-x-2 bg-red-100 text-red-800 px-4 py-2 rounded-full text-sm font-medium">
                ...
                <span>Hype Vision Safety AI</span>
              </div>
              
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                İSG Güvenliği için
                <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent"> Yapay Zeka</span>
              </h1>
              
              <p className="text-xl text-gray-600 leading-relaxed">
                Gelişmiş yapay zeka ve bilgisayarlı görü teknolojileri ile işyeri güvenliğini artırın. 
                Mevcut kamera sistemleriniz üzerinden gerçek zamanlı risk tespiti ve anında uyarı.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
              <div className="bg-red-50 px-6 py-4 border-b border-red-200">
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-gray-900">Canlı Güvenlik Paneli</h3>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-3">
                  <h4 className="font-medium text-gray-900">Son Uyarılar</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Güvenlik <span className="text-red-600">Özellikleri</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Yapay zeka destekli güvenlik çözümlerimiz ile işyeri güvenliğini maksimum seviyeye çıkarın
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Uygulama <span className="text-red-600">Alanları</span>
            </h2>
            <p className="text-xl text-gray-600">
              Farklı sektörlerde kanıtlanmış güvenlik çözümleri
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-orange-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            İşyeri Güvenliğinizi Bir Sonraki Seviyeye Taşıyın
          </h2>
          <p className="text-red-100 text-lg mb-8">
            Hype Vision Safety ile iş kazalarını %85 azaltın ve güvenlik uyumunuzu %98'e çıkarın
          </p>
